...
// MARK: timings
static const uint8_t __not_in_flash(cpu) cyc_00[256] = {4, 10, 7, 6, 4, 4, 7, 4, 4, 11, 7, 6, 4, 4,
...
static const uint8_t __not_in_flash(cpu) cyc_ed[256] = {8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,
...
static const uint8_t __not_in_flash(cpu) cyc_ddfd[256] = {4, 4, 4, 4, 4, 4, 4, 4, 4, 15, 4, 4, 4, 4,
...
void __time_critical_func(z80_step)(z80* const z) {
  if (z->halted) {
    exec_opcode(z, 0x00);
  } else {
